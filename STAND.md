...
**Aktuelle Version: v0.8.6 «Verlässlich»** (Stand 19.07.2026, ROADMAP 496).
**Alle Versionen davor (≤ v0.8.4) sind ARCHIV.** Nie mehr darauf aufbauen.
...
> vergessen, P10-Fund ROADMAP 447) — alle deckungsgleich **0.8.6**, dazu der
