...
**Aktuelle Version: v0.8.8 «Beweglich»** (Stand 19.07.2026, ROADMAP 519).
**Alle Versionen davor (≤ v0.8.6) sind ARCHIV.** Nie mehr darauf aufbauen.
...
> vergessen, P10-Fund ROADMAP 447) — alle deckungsgleich **0.8.8**, dazu der
