...
| `home-pc-start-readiness` | `ready` | status=home_pc_start_dry_run_passed, checks=51/51, warnings=0 | kosmo-home-pc-start-dry-run.sh ausfuehren und fehlende Pflichtchecks beheben. |
