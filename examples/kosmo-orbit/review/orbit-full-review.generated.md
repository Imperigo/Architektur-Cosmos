...
Generated: 2026-06-06T03:05:56.255Z
...
- command contract blocked: 6
- audit trail: `orbit_audit_trail_contract_passed`
...
- office pilot scene: `orbit_office_pilot_scene_ready`
- office pilot scene checks: 13/13
- office pilot scene steps: 4
- office pilot scene roles: 4
- tool registry: `orbit_tool_registry_ready`
- tool registry checks: 13/13
- tool registry tools: 8
- tool registry blocked/review gates: 5
- runtime adapter: `runtime_adapter_contract_passed`
- runtime adapter checks: 16/16
- runtime adapter lanes: 6
- runtime adapter promotion requirements: 6
- KosmoSketch adapter: `kosmosketch_adapter_contract_passed`
- KosmoSketch adapter checks: 20/20
- KosmoSketch target tool: `kosmo-draw.kosmosketch`
...
- local identity: `local_identity_contract_passed`
- local identity checks: 16/16
...
- office memory: `office_memory_readiness_passed`
- office memory checks: 16/16
...
- pilot result draft: `orbit_pilot_result_draft_template_ready`
- pilot result draft checks: 21/21
- pilot result draft slots: 5
- pilot result draft empty slots: 5
- orbit route smoke: `orbit_route_smoke_passed`
- orbit route smoke checks: 264/264
- workspace status: `orbit_blocked_gates_present`
- local runtime bridge: `local_runtime_bridge_passed`
- local runtime bridge progress: 88%
- local runtime bridge lanes: 7 ready / 1 blocked
- local runtime bridge checks: 23/23
