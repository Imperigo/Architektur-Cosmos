...
if (!radialTextSource.includes('centerNeedsFlip') || !radialTextSource.includes('readableLetters')) {
  failures.push('RadialLetterText should flip label reading direction per label, not per letter.');
}
