...
function buildChecks(checkpoint) {
  ...
  return [
    ...
    check('twenty_five_components', checkpoint.summary?.components === 25, checkpoint.summary?.components),
    ...
    check('guard_checks_at_least_260', checkpoint.summary?.guard_checks >= 260, checkpoint.summary?.guard_checks),
