...
function buildChecks(checkpoint) {
  ...
  return [
    ...
    check('eleven_components', checkpoint.summary?.components === 11, checkpoint.summary?.components),
    ...
    check('guard_checks_at_least_113', checkpoint.summary?.guard_checks >= 113, checkpoint.summary?.guard_checks),
