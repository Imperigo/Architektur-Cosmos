...
function buildChecks(checkpoint) {
  ...
  return [
    ...
    check('twenty_three_components', checkpoint.summary?.components === 23, checkpoint.summary?.components),
    ...
    check('guard_checks_at_least_230', checkpoint.summary?.guard_checks >= 230, checkpoint.summary?.guard_checks),
