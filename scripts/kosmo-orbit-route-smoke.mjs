...
function buildReport({ routeSource, roleSwitcherSource, demoReviewSource, projectDashboardSource, designHandoffPanelSource, designPilotSource, designHandoffPanelDataSource, presenterBriefSource, workflowDeltaSource, pilotMeasurementSource, pilotMeasurementKitSource, pilotFacilitatorChecklistSource, pilotResultDraftSource, pilotRunbookSource, pilotSessionTemplateSource, progressMapSource, visionBridgeSource, demoQuestionsSource, installationTopologySource, healthReadinessSource, healthReadinessContractSource, riskRegisterSource, commandContractSource, commandContractDataSource, auditTrailSource, auditTrailDataSource, reviewDecisionDraftSource, runtimeBoundarySource, runtimeAdapterSource, runtimeAdapterDataSource, runtimeContractSource, qualityEvidenceSource, workstationPrioritiesSource, workstationProfileSource, workstationProfileDataSource, localIdentitySource, localIdentityDataSource, dataGovernanceSource, dataGovernanceDataSource, officeMemorySource, officeMemoryDataSource, localStorageDecisionSource, localStorageDecisionDataSource, learningModeSource, permissionMatrixSource, autonomyStatusSource, officeRoutineSource, officeRoutineDataSource, officePilotSceneSource, officePilotSceneDataSource, toolRegistrySource, toolRegistryDataSource, demoReadinessSource, publishReadinessSource, launchDecisionBriefSource, sectionIndexSource, spec }) {
  ...
  const checks = [
    ...
    check('shows_section_index', 'Route renders compact demo section navigation.', source.includes('Demo-Navigation') && source.includes('#workflow-delta') && source.includes('#pilotmessung') && source.includes('#pilot-kit') && source.includes('#pilot-checklist') && source.includes('#pilot-result') && source.includes('#pilotplan') && source.includes('#pilot-session') && source.includes('#fortschritt') && source.includes('#vision') && source.includes('#runtime-contract') && source.includes('#runtime-adapter') && source.includes('#installation') && source.includes('#health') && source.includes('#risiken') && source.includes('#commands') && source.includes('#audit') && source.includes('#demo-ready') && source.includes('#live-gate') && source.includes('#launch-brief') && source.includes('#office-pilot') && source.includes('#tool-registry') && source.includes('#routine') && source.includes('#workstation-profile') && source.includes('#local-identity') && source.includes('#data-governance') && source.includes('#office-memory') && source.includes('#local-storage-decision') && source.includes('#ausbildung') && source.includes('#rechte') && source.includes('#projektpaket') && source.includes('#design-handoff') && source.includes('#design-pilot') && source.includes('#guardrails')),
    check('anchors_core_sections', 'Route contains anchors for core demo sections.', source.includes('id="autonomie"') && source.includes('id="routine"') && source.includes('id="tool-registry"') && source.includes('id="workflow-delta"') && source.includes('id="pilotmessung"') && source.includes('id="pilot-kit"') && source.includes('id="pilot-checklist"') && source.includes('id="pilot-result"') && source.includes('id="pilotplan"') && source.includes('id="pilot-session"') && source.includes('id="vision"') && source.includes('id="demo-ready"') && source.includes('id="live-gate"') && source.includes('id="launch-brief"') && source.includes('id="office-pilot"') && source.includes('id="runtime-contract"') && source.includes('id="runtime-adapter"') && source.includes('id="installation"') && source.includes('id="health"') && source.includes('id="risiken"') && source.includes('id="commands"') && source.includes('id="audit"') && source.includes('id="projektpaket"') && source.includes('id="design-handoff"') && source.includes('id="design-pilot"') && source.includes('id="workstation-profile"') && source.includes('id="local-identity"') && source.includes('id="data-governance"') && source.includes('id="office-memory"') && source.includes('id="local-storage-decision"') && source.includes('id="ausbildung"') && source.includes('id="rechte"') && source.includes('id="rollen"')),
