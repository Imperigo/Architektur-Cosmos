...
async function main() {
  ...
  const report = buildReport({ routeSource, roleSwitcherSource, demoReviewSource, projectDashboardSource, designHandoffPanelSource, designHandoffPanelDataSource, presenterBriefSource, workflowDeltaSource, pilotMeasurementSource, pilotMeasurementKitSource, pilotFacilitatorChecklistSource, pilotResultDraftSource, pilotRunbookSource, pilotSessionTemplateSource, progressMapSource, visionBridgeSource, demoQuestionsSource, installationTopologySource, healthReadinessSource, healthReadinessContractSource, riskRegisterSource, commandContractSource, commandContractDataSource, auditTrailSource, auditTrailDataSource, reviewDecisionDraftSource, runtimeBoundarySource, runtimeContractSource, qualityEvidenceSource, workstationPrioritiesSource, learningModeSource, permissionMatrixSource, autonomyStatusSource, officeRoutineSource, officeRoutineDataSource, demoReadinessSource, publishReadinessSource, launchDecisionBriefSource, sectionIndexSource, spec });
...
function buildReport({ routeSource, roleSwitcherSource, demoReviewSource, projectDashboardSource, designHandoffPanelSource, designHandoffPanelDataSource, presenterBriefSource, workflowDeltaSource, pilotMeasurementSource, pilotMeasurementKitSource, pilotFacilitatorChecklistSource, pilotResultDraftSource, pilotRunbookSource, pilotSessionTemplateSource, progressMapSource, visionBridgeSource, demoQuestionsSource, installationTopologySource, healthReadinessSource, healthReadinessContractSource, riskRegisterSource, commandContractSource, commandContractDataSource, auditTrailSource, auditTrailDataSource, reviewDecisionDraftSource, runtimeBoundarySource, runtimeContractSource, qualityEvidenceSource, workstationPrioritiesSource, learningModeSource, permissionMatrixSource, autonomyStatusSource, officeRoutineSource, officeRoutineDataSource, demoReadinessSource, publishReadinessSource, launchDecisionBriefSource, sectionIndexSource, spec }) {
  ...
  const checks = [
    ...
    check('shows_section_index', 'Route renders compact demo section navigation.', source.includes('Demo-Navigation') && source.includes('#workflow-delta') && source.includes('#pilotmessung') && source.includes('#pilot-kit') && source.includes('#pilot-checklist') && source.includes('#pilot-result') && source.includes('#pilotplan') && source.includes('#pilot-session') && source.includes('#fortschritt') && source.includes('#vision') && source.includes('#runtime-contract') && source.includes('#installation') && source.includes('#health') && source.includes('#risiken') && source.includes('#commands') && source.includes('#audit') && source.includes('#demo-ready') && source.includes('#live-gate') && source.includes('#launch-brief') && source.includes('#routine') && source.includes('#ausbildung') && source.includes('#rechte') && source.includes('#projektpaket') && source.includes('#design-handoff') && source.includes('#guardrails')),
    check('anchors_core_sections', 'Route contains anchors for core demo sections.', source.includes('id="autonomie"') && source.includes('id="routine"') && source.includes('id="workflow-delta"') && source.includes('id="pilotmessung"') && source.includes('id="pilot-kit"') && source.includes('id="pilot-checklist"') && source.includes('id="pilot-result"') && source.includes('id="pilotplan"') && source.includes('id="pilot-session"') && source.includes('id="vision"') && source.includes('id="demo-ready"') && source.includes('id="live-gate"') && source.includes('id="launch-brief"') && source.includes('id="runtime-contract"') && source.includes('id="installation"') && source.includes('id="health"') && source.includes('id="risiken"') && source.includes('id="commands"') && source.includes('id="audit"') && source.includes('id="projektpaket"') && source.includes('id="design-handoff"') && source.includes('id="ausbildung"') && source.includes('id="rechte"') && source.includes('id="rollen"')),
