...
function buildBridge(reports) {
  ...
  const cards = [
    ...
    {
      id: 'github-worker-runtime-rollback-redaction-fixtures',
      title: 'GitHub Worker Runtime Rollback/Redaction Fixtures',
      status: reports.githubWorkerRuntimeRollbackRedactionFixtures?.status === 'innovation_github_worker_runtime_rollback_redaction_fixtures_ready' &&
        reports.githubWorkerRuntimeRollbackRedactionFixturesCheck?.status === 'innovation_github_worker_runtime_rollback_redaction_fixtures_guard_passed'
        ? 'review_only_ready'
        : 'needs_review',
      signal: `${githubWorkerRuntimeRollbackRedactionFixturesSummary.fixture_groups ?? 0} groups, rules ${githubWorkerRuntimeRollbackRedactionFixturesSummary.redaction_rules ?? 0}, rollback ${githubWorkerRuntimeRollbackRedactionFixturesSummary.rollback_steps ?? 0}, runtime ${githubWorkerRuntimeRollbackRedactionFixturesSummary.runtime_executed_now ?? 0}, failures ${githubWorkerRuntimeRollbackRedactionFixturesCheckSummary.failures ?? 0}`,
      owner_action_required: false,
      route_hint: 'Source-free rollback/log-redaction fixtures only; no runtime, rollback, model or private-source execution',
    ...
    {
      id: 'github-worker-runtime-batch-manifest-draft',
      title: 'GitHub Worker Runtime Batch Manifest Draft',
      status: reports.githubWorkerRuntimeBatchManifestDraft?.status === 'innovation_github_worker_runtime_batch_manifest_draft_ready' &&
        reports.githubWorkerRuntimeBatchManifestDraftCheck?.status === 'innovation_github_worker_runtime_batch_manifest_draft_guard_passed'
        ? 'review_only_ready'
        : 'needs_review',
      signal: `${githubWorkerRuntimeBatchManifestDraftSummary.runtime_batch_id || 'no batch'}, prereqs ${githubWorkerRuntimeBatchManifestDraftSummary.prerequisites ?? 0}, blocked ${githubWorkerRuntimeBatchManifestDraftSummary.blocked_prerequisites ?? 0}, gates open ${githubWorkerRuntimeBatchManifestDraftSummary.open_review_gates ?? 0}, executable ${githubWorkerRuntimeBatchManifestDraftSummary.executable_now ? 'yes' : 'no'}, failures ${githubWorkerRuntimeBatchManifestDraftCheckSummary.failures ?? 0}`,
      owner_action_required: false,
      route_hint: 'Review-only runtime batch manifest draft; no manifest/output writes and no runtime execution',
    ...
    {
      id: 'github-worker-runtime-manifest-validator',
      title: 'GitHub Worker Runtime Manifest Validator',
      status: reports.githubWorkerRuntimeManifestValidator?.status === 'innovation_github_worker_runtime_manifest_validator_passed' &&
        reports.githubWorkerRuntimeManifestValidatorCheck?.status === 'innovation_github_worker_runtime_manifest_validator_guard_passed'
        ? 'review_only_ready'
        : 'needs_review',
      signal: `${githubWorkerRuntimeManifestValidatorSummary.validated_manifests ?? 0} manifests, blocked ${githubWorkerRuntimeManifestValidatorSummary.blocked_manifests ?? 0}, review-only ${githubWorkerRuntimeManifestValidatorSummary.review_only_valid_manifests ?? 0}, failures ${githubWorkerRuntimeManifestValidatorCheckSummary.failures ?? 0}`,
      owner_action_required: false,
      route_hint: 'Static metadata validator for runtime manifests; blocks unsafe manifest shapes and never executes runtime',
    ...
    {
      id: 'worktree-guard-audit',
      title: 'Worktree Guard Audit',
      status: ['worktree_guard_audit_dirty_review_required', 'worktree_guard_audit_clean'].includes(reports.worktreeGuardAudit?.status) &&
        reports.worktreeGuardAuditCheck?.status === 'worktree_guard_audit_guard_passed'
        ? 'guard_passed'
        : 'needs_review',
      signal: `${worktreeGuardAuditSummary.entries ?? 0} dirty entries, staged ${worktreeGuardAuditSummary.staged ?? 0}, untracked ${worktreeGuardAuditSummary.untracked ?? 0}, broad stage ${worktreeGuardAuditSummary.broad_stage_allowed ? 'allowed' : 'blocked'}, failures ${worktreeGuardAuditCheckSummary.failures ?? 0}`,
      owner_action_required: false,
      route_hint: 'Worker safety audit for dirty worktree coordination; exact staging only',
  ...
  return {
    ...
    summary: {
      ...
      github_worker_runtime_manifest_validator_status: reports.githubWorkerRuntimeManifestValidator?.status || null,
      github_worker_runtime_manifest_validator_validated_manifests: githubWorkerRuntimeManifestValidatorSummary.validated_manifests ?? null,
      github_worker_runtime_manifest_validator_blocked_manifests: githubWorkerRuntimeManifestValidatorSummary.blocked_manifests ?? null,
      github_worker_runtime_manifest_validator_review_only_valid_manifests: githubWorkerRuntimeManifestValidatorSummary.review_only_valid_manifests ?? null,
      ...
      worktree_guard_audit_status: reports.worktreeGuardAudit?.status || null,
      worktree_guard_audit_entries: worktreeGuardAuditSummary.entries ?? null,
      worktree_guard_audit_staged: worktreeGuardAuditSummary.staged ?? null,
      worktree_guard_audit_untracked: worktreeGuardAuditSummary.untracked ?? null,
      ...
      github_worker_runtime_rollback_redaction_fixtures_status: reports.githubWorkerRuntimeRollbackRedactionFixtures?.status || null,
      ...
      github_worker_runtime_batch_manifest_draft_status: reports.githubWorkerRuntimeBatchManifestDraft?.status || null,
