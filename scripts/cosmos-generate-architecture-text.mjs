...
function readableDe(value) {
  ...
  const dictionary = {
    ...
    'fortress palace garden': 'Festungs-, Palast- und Gartenanlage',
    courtyard_water_system: 'Hof- und Wassersystem',
    'courtyard water system': 'Hof- und Wassersystem',
    nasrid_ornament: 'Nasriden-Ornament',
    'nasrid ornament': 'Nasriden-Ornament',
    microclimate_design: 'Mikroklima-Entwurf',
    'microclimate design': 'Mikroklima-Entwurf',
    world_heritage_landscape: 'Welterbe-Landschaft',
    'world heritage landscape': 'Welterbe-Landschaft',
    nasrid_palace_fortress_garden_and_world_heritage_complex: 'Nasriden-Palast, Festung, Garten und Welterbe-Komplex',
    'nasrid palace fortress garden and world heritage complex': 'Nasriden-Palast, Festung, Garten und Welterbe-Komplex',
    palace_city_with_courtyards_water_gardens_and_defensive_citadel: 'Palaststadt mit Höfen, Wasser, Gärten und Zitadelle',
    'palace city with courtyards water gardens and defensive citadel': 'Palaststadt mit Höfen, Wasser, Gärten und Zitadelle',
    nasrid_palace_city_generalife_and_albayzin_world_heritage_landscape: 'Nasriden-Palaststadt, Generalife und Albaicín als Welterbe-Landschaft',
    'nasrid palace city generalife and albayzin world heritage landscape': 'Nasriden-Palaststadt, Generalife und Albaicín als Welterbe-Landschaft',
    sabika_hill_above_granada: 'Sabika-Hügel über Granada',
    'sabika hill above granada': 'Sabika-Hügel über Granada',
    rammed_earth_and_masonry_walls: 'Stampflehm- und Mauerwerkswände',
    'rammed earth and masonry walls': 'Stampflehm- und Mauerwerkswände',
    stucco_ornament: 'Stuckornament',
    'stucco ornament': 'Stuckornament',
    tilework_zellij: 'Zellij-Fliesenwerk',
    'tilework zellij': 'Zellij-Fliesenwerk',
    water_channels_and_basins: 'Wasserkanäle und Becken',
    'water channels and basins': 'Wasserkanäle und Becken',
    water_channels: 'Wasserkanäle',
    'water channels': 'Wasserkanäle',
    patio_sequence: 'Patio-Sequenz',
    'patio sequence': 'Patio-Sequenz',
    shade_water_microclimate: 'Schatten-Wasser-Mikroklima',
    'shade water microclimate': 'Schatten-Wasser-Mikroklima',
    tourism_fragility_water_maintenance: 'Tourismusdruck, Fragilität und Wasserunterhalt',
    'tourism fragility water maintenance': 'Tourismusdruck, Fragilität und Wasserunterhalt',
    patio_water_layer_candidate: 'Patio- und Wasser-Layer-Kandidat',
    'patio water layer candidate': 'Patio- und Wasser-Layer-Kandidat',
    ornament_surface_layer_candidate: 'Ornament- und Oberflächen-Layer-Kandidat',
    'ornament surface layer candidate': 'Ornament- und Oberflächen-Layer-Kandidat',
    double_shell_dome: 'Doppelschalenkuppel',
    'double shell dome': 'Doppelschalenkuppel',
    herringbone_brickwork: 'Herringbone-Ziegelverband',
    'herringbone brickwork': 'Herringbone-Ziegelverband',
    self_supporting_construction: 'selbsttragende Konstruktion',
    'self supporting construction': 'selbsttragende Konstruktion',
    renaissance_engineering: 'Renaissance-Ingenieurwesen',
    'renaissance engineering': 'Renaissance-Ingenieurwesen',
    urban_landmark: 'Stadtzeichen',
    'urban landmark': 'Stadtzeichen',
    construction_machine: 'Baumaschine',
    'construction machine': 'Baumaschine',
    structural_rings: 'strukturelle Ringe',
    'structural rings': 'strukturelle Ringe',
    cathedral_dome_engineering_and_urban_landmark: 'Domkuppel, Ingenieurbau und Stadtzeichen',
    'cathedral dome engineering and urban landmark': 'Domkuppel, Ingenieurbau und Stadtzeichen',
    self_supporting_double_shell_masonry_dome_with_ribs_and_herringbone_brickwork: 'selbsttragende Doppelschalen-Mauerwerkskuppel mit Rippen und Herringbone-Ziegelverband',
    'self supporting double shell masonry dome with ribs and herringbone brickwork': 'selbsttragende Doppelschalen-Mauerwerkskuppel mit Rippen und Herringbone-Ziegelverband',
    dense_florentine_city_center_and_cathedral_square: 'dichtes Florentiner Stadtzentrum und Domplatz',
    'dense florentine city center and cathedral square': 'dichtes Florentiner Stadtzentrum und Domplatz',
    piazza_del_duomo_florence_cathedral_complex_and_urban_skyline: 'Piazza del Duomo, Kathedralkomplex und Florentiner Stadtsilhouette',
    'piazza del duomo florence cathedral complex and urban skyline': 'Piazza del Duomo, Kathedralkomplex und Florentiner Stadtsilhouette',
    brick_double_shell: 'Ziegel-Doppelschale',
    'brick double shell': 'Ziegel-Doppelschale',
    stone_ribs: 'Steinrippen',
    'stone ribs': 'Steinrippen',
    stone_and_timber_tie_rings: 'Stein- und Holz-Zugringe',
    'stone and timber tie rings': 'Stein- und Holz-Zugringe',
    terracotta_roof_tiles: 'Terrakotta-Dachziegel',
    'terracotta roof tiles': 'Terrakotta-Dachziegel',
    masonry_drum: 'Mauerwerkstrommel',
    'masonry drum': 'Mauerwerkstrommel',
    inner_shell: 'innere Schale',
    'inner shell': 'innere Schale',
    outer_shell: 'äußere Schale',
    'outer shell': 'äußere Schale',
    compression_ring: 'Kompressionsring',
    'compression ring': 'Kompressionsring',
    lantern_stonework: 'Steinwerk der Laterne',
    'lantern stonework': 'Steinwerk der Laterne',
    lifting_machines: 'Hebemaschinen',
    'lifting machines': 'Hebemaschinen',
    inter_shell_passages: 'Zwischenräume der Schalen',
    'inter shell passages': 'Zwischenräume der Schalen',
    florence_skyline: 'Florentiner Stadtsilhouette',
    'florence skyline': 'Florentiner Stadtsilhouette',
    architect_myth_vs_collective_worksite: 'Architektenmythos versus kollektive Baustelle',
    'architect myth vs collective worksite': 'Architektenmythos versus kollektive Baustelle',
    double_shell_layer_candidate: 'Doppelschalen-Layer-Kandidat',
    'double shell layer candidate': 'Doppelschalen-Layer-Kandidat',
    herringbone_brickwork_layer_candidate: 'Herringbone-Ziegelverband-Layer-Kandidat',
    'herringbone brickwork layer candidate': 'Herringbone-Ziegelverband-Layer-Kandidat',
    construction_sequence_layer_candidate: 'Bauablauf-Layer-Kandidat',
    'construction sequence layer candidate': 'Bauablauf-Layer-Kandidat',
    ...
    grande_perspective: 'Grande Perspective',
    'grande perspective': 'Grande Perspective',
    axis_of_power: 'Machtachse',
    'axis of power': 'Machtachse',
    water_theatre: 'Wassertheater',
    'water theatre': 'Wassertheater',
    parterre_bosquet_system: 'Parterre-Bosquet-System',
    'parterre bosquet system': 'Parterre-Bosquet-System',
    royal_landscape_control: 'höfische Landschaftskontrolle',
    'royal landscape control': 'höfische Landschaftskontrolle',
    royal_formal_garden_and_power_landscape: 'königlicher Formalgarten und Machtlandschaft',
    'royal formal garden and power landscape': 'königlicher Formalgarten und Machtlandschaft',
    french_formal_garden_with_grande_perspective_parterres_bosquets_fountains_and_grand_canal: 'französischer Formalgarten mit Grande Perspective, Parterres, Bosquets, Fontänen und Grand Canal',
    'french formal garden with grande perspective parterres bosquets fountains and grand canal': 'französischer Formalgarten mit Grande Perspective, Parterres, Bosquets, Fontänen und Grand Canal',
    controlled_royal_landscape_southwest_of_paris: 'kontrollierte königliche Landschaft südwestlich von Paris',
    'controlled royal landscape southwest of paris': 'kontrollierte königliche Landschaft südwestlich von Paris',
    palace_park_axis_bosquet_and_grand_canal_world_heritage_landscape: 'Schloss-Park-Achse, Bosquets und Grand Canal als Welterbe-Landschaft',
    'palace park axis bosquet and grand canal world heritage landscape': 'Schloss-Park-Achse, Bosquets und Grand Canal als Welterbe-Landschaft',
    earth_modelling: 'Erdmodellierung',
    'earth modelling': 'Erdmodellierung',
    gravel_paths: 'Kieswege',
    'gravel paths': 'Kieswege',
    clipped_hedges_and_tree_walls: 'geschnittene Hecken und Baumwände',
    'clipped hedges and tree walls': 'geschnittene Hecken und Baumwände',
    water_basins_and_fountains: 'Wasserbecken und Fontänen',
    'water basins and fountains': 'Wasserbecken und Fontänen',
    sculptural_stone_and_bronze: 'skulpturaler Stein und Bronze',
    'sculptural stone and bronze': 'skulpturaler Stein und Bronze',
    hydraulic_pipes_and_pumps: 'hydraulische Leitungen und Pumpen',
    'hydraulic pipes and pumps': 'hydraulische Leitungen und Pumpen',
    bosquet_tree_rooms: 'Bosquet-Baumräume',
    'bosquet tree rooms': 'Bosquet-Baumräume',
    grand_canal_water_body: 'Wasserkörper des Grand Canal',
    'grand canal water body': 'Wasserkörper des Grand Canal',
    clipped_hedges: 'geschnittene Hecken',
    'clipped hedges': 'geschnittene Hecken',
    water_basins: 'Wasserbecken',
    'water basins': 'Wasserbecken',
    axis_and_perspective: 'Achse und Perspektive',
    'axis and perspective': 'Achse und Perspektive',
    hydraulic_network: 'hydraulisches Netzwerk',
    'hydraulic network': 'hydraulisches Netzwerk',
    grande_perspective_tag: 'Grande Perspective',
    bosquet_rooms: 'Bosquet-Räume',
    'bosquet rooms': 'Bosquet-Räume',
    controlled_royal_landscape: 'kontrollierte königliche Landschaft',
    'controlled royal landscape': 'kontrollierte königliche Landschaft',
    power_water_maintenance_labor: 'Macht, Wasser, Unterhalt und Arbeit',
    'power water maintenance labor': 'Macht, Wasser, Unterhalt und Arbeit',
    axis_water_bosquet_layer_candidate: 'Achsen-, Wasser- und Bosquet-Layer-Kandidat',
    'axis water bosquet layer candidate': 'Achsen-, Wasser- und Bosquet-Layer-Kandidat',
    visibility_corridor_layer_candidate: 'Sichtkorridor-Layer-Kandidat',
    'visibility corridor layer candidate': 'Sichtkorridor-Layer-Kandidat',
