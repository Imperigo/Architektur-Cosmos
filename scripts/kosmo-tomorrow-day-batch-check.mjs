...
function checkPlan(plan) {
  ...
  expect(startSequence.includes('innovation-github-worker-runtime-batch-manifest-draft'), findings, 'start_sequence_github_worker_runtime_batch_manifest_draft', 'Start sequence must include GitHub worker runtime batch manifest draft.');
