...
async function writePackage({ inputRoot, projectRoot, projectId, projectName, origin, discovered }) {
  ...
  const files = {
    ...
    'design/context-source-map.generated.json': json(buildContextSourceMapSeed(projectId, 'kosmosprepare_import')),
    'design/context-source-map.generated.md': renderContextSourceMapSeed(projectId),
    'design/context-source-review.generated.json': json(buildContextSourceReviewSeed(projectId, 'kosmosprepare_import')),
    'design/context-source-review.generated.md': renderContextSourceReviewSeed(projectId),
    'design/context-source-mapping.json': json(buildContextSourceMappingSeed(projectId, 'kosmosprepare_import')),
