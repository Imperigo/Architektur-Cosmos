...
const files = [
  ...
  'OrbitKosmoSketchAdapterContract.tsx',
...
function buildReport(sources) {
  ...
  const checks = [
    ...
    check('kosmosketch_adapter_responsive', 'KosmoSketch adapter uses responsive cards for routing, job contract, artifacts and blocked actions.', sources['OrbitKosmoSketchAdapterContract.tsx'].includes('lg:grid-cols-[0.95fr_1.05fr]') && sources['OrbitKosmoSketchAdapterContract.tsx'].includes('xl:grid-cols-3') && sources['OrbitKosmoSketchAdapterContract.tsx'].includes('lg:grid-cols-[0.9fr_1.1fr]')),
