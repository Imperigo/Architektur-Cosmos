...
function buildChecks(roadmap) {
  ...
  return [
    ...
    check('owner_unlock_checkpoint_components_ready', roadmap.summary?.owner_unlock_components_ready === roadmap.summary?.owner_unlock_components && roadmap.summary?.owner_unlock_components >= 11, `${roadmap.summary?.owner_unlock_components_ready}/${roadmap.summary?.owner_unlock_components}`),
    check('owner_unlock_checkpoint_guards_ready', roadmap.summary?.owner_unlock_guard_checks_passed === roadmap.summary?.owner_unlock_guard_checks && roadmap.summary?.owner_unlock_guard_checks >= 113, `${roadmap.summary?.owner_unlock_guard_checks_passed}/${roadmap.summary?.owner_unlock_guard_checks}`),
    ...
    check('source_free_tasks_bounded', roadmap.summary?.source_free_codex_tasks_remaining <= 3, roadmap.summary?.source_free_codex_tasks_remaining),
