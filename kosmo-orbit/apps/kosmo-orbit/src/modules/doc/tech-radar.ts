...
export const TECH_RADAR: RadarPosten[] = [
  ...
  { bereich: 'Beobachtung (Scan 19.07.)', baustein: 'Gemini Omni Flash', entscheid: 'TEST', paket: 'Gemini API (live seit 30.06.)', lizenz: 'proprietär', kommentar: 'Seit 30.06. live, kein Preview mehr (~0.10 USD/s Video) — das KosmoVis-Bridge-Skeleton wäre erstmals smoke-testbar. Owner-Entscheid bleibt: Schlüssel, Kosten, Datenabfluss (Cloud-only, DSGVO).', unverifiziert: true },
  ...
  // Notion-Scan-Delta 09.–10.07. (AI-SCAN-AUSWERTUNG-0.6.8.md) — Scan-Aussagen, nicht selbst verifiziert
  { bereich: 'Beobachtung (Scan 10.07.)', baustein: 'Docling v2 + Granite-Docling-258M', entscheid: 'ADOPT', paket: 'github.com/docling-project/docling', lizenz: 'Apache-2.0 (laut Scan)', kommentar: 'Lokale PDF→MD/JSON-Extraktion für den Wissens-Import — in v0.6.8 als tools/docling-ingest eingebaut (mit ehrlichem Fehlpfad, falls nicht installiert).', unverifiziert: true },
  { bereich: 'Beobachtung (Scan 10.07.)', baustein: 'Markitdown (Microsoft)', entscheid: 'EVALUATE', paket: 'github.com/microsoft/markitdown', lizenz: 'MIT (laut Scan)', kommentar: 'Leichter PDF/Office→Markdown-Konverter — dokumentierte Alternative in derselben Import-Naht wie Docling.', unverifiziert: true },
  { bereich: 'Beobachtung (Scan 10.07.)', baustein: 'RAG-Anything (HKUDS)', entscheid: 'WATCH', paket: 'github.com/HKUDS/RAG-Anything', lizenz: 'MIT (laut Scan)', kommentar: 'Multimodales RAG über dem neuen Wissens-Import — 0.6.9-Kandidat, erst wenn der Ingest-Unterbau steht.', unverifiziert: true },
  ...
  { bereich: 'Beobachtung (Scan 19.07.)', baustein: 'swisstopo-mcp (CH-Geodaten als MCP)', entscheid: 'EVALUATE', paket: 'github.com/malkreide/swisstopo-mcp', lizenz: 'widersprüchlich ⚠ (18.07. MIT · 19.07. «prüfen»)', kommentar: 'ÖREB/LV95/STAC/WMTS ohne API-Key — Kandidat für die Standort-/Parzellen-Kette in KosmoData (v0.8.6+); erst gegen die neue MCP-Spec (28.07.) prüfen. Die Scans widersprechen sich zur Lizenz — vor jedem Einbau SELBST verifizieren.', unverifiziert: true },
  ...
  // Scan-Delta 19.07. (AI-SCAN-AUSWERTUNG-0.8.6.md) — Scan-Aussagen, nicht selbst verifiziert
  { bereich: 'Beobachtung (Scan 19.07.)', baustein: 'Typst 0.15.1', entscheid: 'WATCH', paket: 'typst.app', lizenz: 'Apache-2.0 (laut Scan)', kommentar: 'Bug-fix-Release vom 17.07. (SVG-Output-Formatierung, «typst eval»-Exit-Code) — nur relevant, falls die Publish-Kette je auf Typst setzt; heute bewusst Eigenbau-SVG.', unverifiziert: true },
];
