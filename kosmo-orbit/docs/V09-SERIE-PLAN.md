...
## Platzhalter 0.9.11–0.9.50 (noch offen — Owner füllt per W0)

Laufendes Owner-Feedback · Werkzeug-Vertiefungen (u.a. Treppen-Wendelung
falls verschoben, KSelect/UI-Härtungen, Objekt-/Möbel-Bibliothek,
Werkplan-Vertiefungen) · HomeStation-Vollausbau (sobald Home-PC bereit:
Worker/Render/lokale Modelle in echt) · KosmoTrain (bleibt bedingt:
Worker-Bericht) · v1.0-Vorbereitung am Serienende (Voll-E2E-Generalprobe).
