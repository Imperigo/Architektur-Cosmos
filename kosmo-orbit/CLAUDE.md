...
> **⚠️ ZUERST: Stand prüfen.** Aktuelle Version = **v0.9.0** (Stand 22.07.2026);
...
> **0.9.0**. Details in `../STAND.md`. **Kurswechsel:** v0.8.11 war der
...
1. `ROADMAP.md` — 613 nummerierte Einträge (Stand v0.9.0), jeder ein
...
npm test                    # 1180 Kernel + 1771 App + 330 KI + 54 Contracts + 44 Data + 8 Lizenz + 111 UI = 3498 (Stand v0.9.0)
