...
> **⚠️ ZUERST: Stand prüfen.** Aktuelle Version = **v0.8.5** (Stand 19.07.2026);
...
1. `ROADMAP.md` — 485 nummerierte Einträge (Stand v0.8.5), jeder ein
...
npm test                    # 1010 Kernel + 1671 App + 290 KI + 41 Contracts + 44 Data + 8 Lizenz + 106 UI = 3170 (Stand v0.8.5)
