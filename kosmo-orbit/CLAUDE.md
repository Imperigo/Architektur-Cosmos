...
> **⚠️ ZUERST: Stand prüfen.** Aktuelle Version = **v0.8.4** (Stand 18.07.2026);
...
1. `ROADMAP.md` — 474 nummerierte Einträge (Stand v0.8.4), jeder ein
...
npm test                    # 1010 Kernel + 1616 App + 268 KI + 41 Contracts + 44 Data + 8 Lizenz + 106 UI = 3093 (Stand v0.8.4)
