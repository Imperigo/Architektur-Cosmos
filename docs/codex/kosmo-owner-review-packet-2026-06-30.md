...
Generated: 2026-06-30T06:54:32.804Z
Status: `owner_review_packet_ready`

## Summary

- Data lane: kosmodata_lane_sweep_failed (24/26)
- Questions: 6
...
1. Owner Question Brief
   ...
   - JSON: `data/kosmo-owner-question-brief-2026-06-30.json`
   - Markdown: `docs/codex/kosmo-owner-question-brief-2026-06-30.md`
   - Required status: `owner_question_brief_ready`
2. Question Brief Guard
   - Purpose: Confirm the question brief is safe to present.
   - JSON: `data/kosmo-owner-question-brief-check-2026-06-30.json`
   - Markdown: `docs/codex/kosmo-owner-question-brief-check-2026-06-30.md`
...
3. Owner Answer Intake
   ...
   - JSON: `examples/kosmo-references/provenance/owner-answer-intake-template-2026-06-30.json`
   - Markdown: `docs/codex/kosmo-owner-answer-intake-template-2026-06-30.md`
...
4. Owner Answer Intake Check
   ...
   - JSON: `data/kosmo-owner-answer-intake-check-2026-06-30.json`
   - Markdown: `docs/codex/kosmo-owner-answer-intake-check-2026-06-30.md`
...
5. Session Edit Plan
   ...
   - JSON: `data/kosmo-owner-answer-session-edit-plan-2026-06-30.json`
   - Markdown: `docs/codex/kosmo-owner-answer-session-edit-plan-2026-06-30.md`
...
6. Source Root Owner Decision Packet
   ...
   - JSON: `data/kosmo-source-root-owner-decision-packet-2026-06-30.json`
   - Markdown: `docs/codex/kosmo-source-root-owner-decision-packet-2026-06-30.md`
