...
Generated: 2026-06-30T07:03:55.850Z
...
- `source-root-session-record-preview` -> `examples/kosmo-references/provenance/source-root-decision-session-2026-06-30.json` (source_root_decision_session_record, writes now: no)
