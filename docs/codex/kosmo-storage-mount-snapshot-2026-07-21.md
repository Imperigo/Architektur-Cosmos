...
Generated: 2026-07-21T15:54:44.989Z
...
- Data mount total/available GiB: 3666.5/3133.8
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- |
| `/mnt/data` | yes | yes | ext4 | 3666.5 | 3133.8 | 11 | _archive_logs, ai-models, Applikationen Andrin, ArchitekturKosmos, ComfyUI, kosmo-blender-fork, kosmo-verify, lost+found, swiss-dwellings, tools, Zum_Archivieren |
...
| `/mnt/data/ArchitekturKosmos` | yes | no | ext4 | 3666.5 | 3133.8 | 20 | _autonomy, _Claude-Memory, _design-konzept, _incoming, _pilot, .obsidian, .pytest_cache, 00 Inbox, 04 Brain Reports, 05 Decisions, 09 Codex Memory, 11_AI_Workflow |
| `/mnt/data/ArchitekturKosmos/11_AI_Workflow/OneDrive_2026-06-09` | yes | no | ext4 | 3666.5 | 3133.8 | 15 | _build_briefing_pdf.py, 00 Architekturkosmos Zentrale, 00 Einrichtung Home_PC, 12 Architektur Cosmos, alt, Andrin-Owner-Pakete, ANLEITUNG.txt, Architecture-Cosmos_Status_2026-06-02.pdf, Architekturkosmos_Status_2026-06-02.pdf, KosmoDraw, KosmoOrbit_Status_Progress_2026-06-02.pdf, Recht |
| `/home/andrin-baumann/ArchitekturKosmos Onedrive` | yes | no | ext4 | 1831.7 | 1609.6 | 3 | ___All_Errors.txt, __11 AI Workflow, 11 AI Workflow |
