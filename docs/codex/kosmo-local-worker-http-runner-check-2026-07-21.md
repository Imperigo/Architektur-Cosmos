...
Generated: 2026-07-21T15:52:40.515Z
...
- passed: `safe_input_root:docs/codex/kosmoasset-source-candidate-map-2026-07-21.md` - Safe input must stay under data/, docs/ or examples/: docs/codex/kosmoasset-source-candidate-map-2026-07-21.md
- passed: `safe_input_not_truncated:docs/codex/kosmoasset-source-candidate-map-2026-07-21.md` - Safe input should not be truncated for the default smoke task: docs/codex/kosmoasset-source-candidate-map-2026-07-21.md
- passed: `safe_input_root:data/kosmo-data-lane-command-router-2026-07-21.json` - Safe input must stay under data/, docs/ or examples/: data/kosmo-data-lane-command-router-2026-07-21.json
- passed: `safe_input_not_truncated:data/kosmo-data-lane-command-router-2026-07-21.json` - Safe input should not be truncated for the default smoke task: data/kosmo-data-lane-command-router-2026-07-21.json
- passed: `safe_input_root:data/kosmo-worker-boundary-pack-check-2026-07-21.json` - Safe input must stay under data/, docs/ or examples/: data/kosmo-worker-boundary-pack-check-2026-07-21.json
- passed: `safe_input_not_truncated:data/kosmo-worker-boundary-pack-check-2026-07-21.json` - Safe input should not be truncated for the default smoke task: data/kosmo-worker-boundary-pack-check-2026-07-21.json
