...
Generated: 2026-06-16T05:30:34.559Z
...
| --- | --- | --- | ---: |
| OneDrive Sync Errors | passed | yes | 338ms |
| Storage Mount Snapshot | passed | yes | 251ms |
| Source Root Locator | passed | yes | 465ms |
| Source Root Selection Brief | passed | yes | 244ms |
...
| Private Library Diagnostic Metadata | passed | yes | 279ms |
| Source Root Blocker Refresh | passed | yes | 235ms |
| Source Root Owner Action Card | passed | yes | 237ms |
| Source Root Owner Decision Packet | passed | yes | 239ms |
| Source Root Owner Decision Packet Check | passed | yes | 241ms |
| Source Root Decision Dry Run | passed | yes | 247ms |
| Source Root Post-Owner Activation Queue | passed | yes | 246ms |
| Source Root Post-Owner Activation Queue Check | passed | yes | 246ms |
| Source Root Owner Final Decision Brief | passed | yes | 244ms |
| Source Root Owner Choice Consequence Matrix | passed | yes | 242ms |
| Local Model Inventory | passed | yes | 441ms |
| Bootstrap Data Lane Sweep | passed | no | 22475ms |
| Bootstrap Router | passed | yes | 244ms |
| Core Data Lane Sweep | passed | yes | 16353ms |
| Pilot Evidence Matrix | passed | yes | 242ms |
| Pilot Gap Label Review | passed | yes | 243ms |
| Pilot Gap Label Review Check | passed | yes | 240ms |
| Private Source Inventory Plan | passed | yes | 239ms |
...
| Asset Source Candidate Map | passed | yes | 238ms |
| Asset Candidate Taxonomy Review | passed | yes | 238ms |
| Asset Candidate Taxonomy Review Check | passed | yes | 235ms |
| Core Router | passed | yes | 241ms |
| Worker Boundary Pack | passed | yes | 234ms |
| Worker Boundary Pack Check | passed | yes | 248ms |
| Source Root Activation Preflight | passed | yes | 247ms |
| Private Metadata Inventory Runner | passed | yes | 251ms |
| Private Metadata Inventory Fixture Smoke | passed | yes | 317ms |
| Private Metadata Inventory Check | passed | yes | 547ms |
| Local Worker Task Pack Refresh | passed | yes | 251ms |
| Local Worker HTTP Runner Smoke | passed | yes | 240ms |
| Local Worker HTTP Runner Check | passed | yes | 242ms |
...
| Local Worker Execution Runbook | passed | yes | 234ms |
| Local Worker Execution Runbook Check | passed | yes | 238ms |
| Local Worker Output Contract Review | passed | yes | 245ms |
| Local Worker Output Contract Review Check | passed | yes | 252ms |
| Owner Review Packet | passed | yes | 248ms |
| Owner Review Packet Check | passed | yes | 254ms |
| Owner Review Session Brief | passed | yes | 249ms |
| Owner Review Session Brief Check | passed | yes | 233ms |
| Night Loop Checkpoint | passed | yes | 228ms |
| Source-Independent Work Queue | passed | yes | 241ms |
| Innovation Lane Plan | passed | yes | 1141ms |
| Innovation Smoke | passed | yes | 1785ms |
| GitHub Discovery | passed | yes | 1031ms |
| GitHub Discovery Check | passed | yes | 259ms |
| GitHub Review Queue | passed | yes | 260ms |
| GitHub Review Queue Check | passed | yes | 244ms |
| GitHub README Signal Scan | passed | yes | 5421ms |
| GitHub README Signal Scan Check | passed | yes | 239ms |
| GitHub Fixture Contract Plan | passed | yes | 237ms |
| GitHub Fixture Contract Plan Check | passed | yes | 241ms |
| GitHub Fixture Skeletons | passed | yes | 240ms |
| GitHub Fixture Skeletons Check | passed | yes | 244ms |
| GitHub Fixture Payloads | passed | yes | 247ms |
| GitHub Fixture Payloads Check | passed | yes | 238ms |
| GitHub Fixture Payload Smoke | passed | yes | 243ms |
| GitHub Fixture Payload Smoke Check | passed | yes | 243ms |
| Orbit Status Bridge | passed | yes | 256ms |
