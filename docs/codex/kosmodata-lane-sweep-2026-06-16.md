...
Generated: 2026-06-16T12:31:11.408Z
...
- Source-root locator probable/candidates: 0/1010
- Source-root locator mirrors/sync roots: 68/5
...
| --- | --- | ---: | --- |
| KosmoReferences Nightly Gate | passed | 8325ms | `data/kosmoreferences-nightly-gate-2026-06-16.json` |
| KosmoAsset Seed Full Review | passed | 3702ms | `examples/kosmo-assets/kosmoreferences-pilot-seed-library-2026-06-13/review/asset-full-review.generated.json` |
| Human Decision Queue | passed | 242ms | `data/kosmo-human-decision-queue-2026-06-16.json` |
| Owner Decision Batches | passed | 243ms | `data/kosmo-human-decision-owner-batches-2026-06-16.json` |
| Local Worker Output Review | passed | 241ms | `data/kosmo-local-worker-output-review-2026-06-16.json` |
| Pilot Evidence Matrix | passed | 247ms | `data/kosmoreferences-pilot-evidence-matrix-2026-06-16.json` |
| Villa Savoye Provenance Review Brief | passed | 240ms | `data/villa-savoye-provenance-review-brief-2026-06-16.json` |
| Ingenbohl PDF Extraction Brief | passed | 243ms | `data/ingenbohl-pdf-extraction-decision-brief-2026-06-16.json` |
| Sogn Benedetg Source-Root Brief | passed | 242ms | `data/sogn-benedetg-source-root-decision-brief-2026-06-16.json` |
| Source Root Locator | passed | 427ms | `data/kosmo-source-root-locator-2026-06-16.json` |
| Source Root Selection Brief | passed | 236ms | `data/kosmo-source-root-selection-brief-2026-06-16.json` |
| Source Root Decision Session Check | passed | 238ms | `data/kosmo-source-root-decision-session-check-2026-06-16.json` |
| Private Source Inventory Plan | passed | 239ms | `data/kosmo-private-source-inventory-plan-2026-06-16.json` |
| Private Inventory Output Template | passed | 242ms | `examples/kosmo-references/private-inventory/private-inventory-output-template-2026-06-16.json` |
| Private Inventory Output Check | passed | 236ms | `data/kosmo-private-inventory-output-check-2026-06-16.json` |
| Owner Next Review Brief | passed | 247ms | `data/kosmo-owner-next-review-brief-2026-06-16.json` |
| Owner Review Card Set | passed | 252ms | `data/kosmo-owner-review-card-set-2026-06-16.json` |
| Owner Answer Sheet | passed | 248ms | `data/kosmo-owner-answer-sheet-2026-06-16.json` |
| Owner Answer Sheet Check | passed | 246ms | `data/kosmo-owner-answer-sheet-check-2026-06-16.json` |
| Owner Answer Intake Template | passed | 241ms | `examples/kosmo-references/provenance/owner-answer-intake-template-2026-06-16.json` |
| Owner Answer Intake Check | passed | 244ms | `data/kosmo-owner-answer-intake-check-2026-06-16.json` |
| Owner Answer Session Edit Plan | passed | 239ms | `data/kosmo-owner-answer-session-edit-plan-2026-06-16.json` |
| Owner Question Brief | passed | 235ms | `data/kosmo-owner-question-brief-2026-06-16.json` |
| Owner Question Brief Check | passed | 238ms | `data/kosmo-owner-question-brief-check-2026-06-16.json` |
