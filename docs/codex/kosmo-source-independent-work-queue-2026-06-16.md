...
Generated: 2026-06-16T17:45:36.599Z
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `owner_source_root_choice` | owner_decision | owner_or_overseer | completed_review_only | no | no | `review docs/codex/kosmo-source-root-owner-choice-consequence-matrix-2026-06-16.md` | recorded select_existing_root_for_private_diagnostic at /mnt/archiv/ArchitekturKosmos/Assets |
...
| `codex_orbit_status_refresh` | orbit | codex | completed_review_only | no | no | `npm run kosmo:orbit-status-bridge` | completed 85 cards, blockers 6, owner 19 |
