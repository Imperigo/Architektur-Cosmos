...
Generated: 2026-06-30T07:03:56.317Z
Status: `owner_unlock_session_apply_guard_waiting_for_manual_apply`

## Summary

- Mode: waiting_for_manual_apply
- Target file: `examples/kosmo-references/provenance/source-root-decision-session-2026-06-30.json`
- Session path: `examples/kosmo-references/provenance/source-root-decision-session-2026-06-30.json`
- Fixture session: no
