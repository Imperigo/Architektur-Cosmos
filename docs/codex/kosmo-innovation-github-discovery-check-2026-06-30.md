...
Generated: 2026-06-30T06:39:42.257Z
...
- passed: `primary_source:hwaniiidev/BIM-LLM` - hwaniiidev/BIM-LLM must be a primary GitHub repository.
- passed: `github_url:hwaniiidev/BIM-LLM` - hwaniiidev/BIM-LLM must use a GitHub URL.
- passed: `no_execute:hwaniiidev/BIM-LLM` - hwaniiidev/BIM-LLM must not install/download now.
- passed: `no_private:hwaniiidev/BIM-LLM` - hwaniiidev/BIM-LLM must not allow private content.
- passed: `public_ready_zero:hwaniiidev/BIM-LLM` - hwaniiidev/BIM-LLM must keep public-ready at 0.
- passed: `primary_source:Mikillio/bim-wiki-deps` - Mikillio/bim-wiki-deps must be a primary GitHub repository.
- passed: `github_url:Mikillio/bim-wiki-deps` - Mikillio/bim-wiki-deps must use a GitHub URL.
- passed: `no_execute:Mikillio/bim-wiki-deps` - Mikillio/bim-wiki-deps must not install/download now.
- passed: `no_private:Mikillio/bim-wiki-deps` - Mikillio/bim-wiki-deps must not allow private content.
- passed: `public_ready_zero:Mikillio/bim-wiki-deps` - Mikillio/bim-wiki-deps must keep public-ready at 0.
