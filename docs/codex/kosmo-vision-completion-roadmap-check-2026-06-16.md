...
Generated: 2026-06-16T18:00:16.516Z
Status: `vision_completion_roadmap_guard_failed`
...
- failed: `status_ready` - vision_completion_roadmap_needs_review
...
- passed: `six_phases` - 6
- failed: `owner_unlock_checkpoint_11_components` - 20/27
- failed: `owner_unlock_checkpoint_113_guards` - 276/283
- passed: `owner_unlock_handoff_current` - 330
...
- passed: `phase_1_codex_now_mentions_dry_run` - Use checkpoint 20/27 components and 276/283 guards Run npm run kosmo:owner-unlock-answer-dry-run -- --answer "<owner_reply>" before any intake edit Keep source-root private diagnostics blocked until reviewed intake and source-root guards pass
