...
- passed: `source_ref:examples/kosmo-references/provenance/source-root-decision-session-2026-06-14.json` - Source ref present: examples/kosmo-references/provenance/source-root-decision-session-2026-06-14.json
- passed: `source_ref:data/kosmo-owner-review-card-set-2026-06-14.json` - Source ref present: data/kosmo-owner-review-card-set-2026-06-14.json
