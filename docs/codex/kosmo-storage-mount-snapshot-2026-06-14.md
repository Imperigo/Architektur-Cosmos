...
Generated: 2026-06-14T13:18:43.275Z
...
- Data mount total/available GiB: 3666.5/3269.5
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- |
| `/mnt/data` | yes | yes | ext4 | 3666.5 | 3269.5 | 9 | _archive_logs, ai-models, Applikationen Andrin, ArchitekturKosmos, ComfyUI, kosmo-verify, lost+found, tools, Zum_Archivieren |
| `/mnt/archiv` | yes | yes | ext4 | 11086.8 | 10498.2 | 4 | 01 ArchitekturKosmos Projekt, ArchitekturKosmos, FromSSD, lost+found |
| `/mnt/data/ArchitekturKosmos` | yes | no | ext4 | 3666.5 | 3269.5 | 7 | _incoming, .pytest_cache, 11_AI_Workflow, Code, KosmoOrbit, KosmoZentrale, tools |
| `/mnt/data/ArchitekturKosmos/11_AI_Workflow/OneDrive_2026-06-09` | yes | no | ext4 | 3666.5 | 3269.5 | 14 | _build_briefing_pdf.py, 00 Architekturkosmos Zentrale, 00 Einrichtung Home_PC, 12 Architektur Cosmos, alt, Andrin-Owner-Pakete, ANLEITUNG.txt, Architecture-Cosmos_Status_2026-06-02.pdf, Architekturkosmos_Status_2026-06-02.pdf, KosmoDraw, KosmoOrbit_Status_Progress_2026-06-02.pdf, Recht |
| `/home/andrin-baumann/ArchitekturKosmos Onedrive` | yes | no | ext4 | 1831.7 | 1635.9 | 3 | ___All_Errors.txt, __11 AI Workflow, 11 AI Workflow |
