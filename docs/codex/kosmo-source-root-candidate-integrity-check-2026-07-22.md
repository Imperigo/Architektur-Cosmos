...
Generated: 2026-07-22T08:13:21.384Z
...
- Archive path options: 7
- Workflow mirror options: 3
...
| `possible-source-root-home-andrin-baumann-architektur-cosmos-wissen-vault-buecher` | yes | / | unknown_owner_confirmation_required | owner_confirmation_required | 148 | Keep blocked unless owner/overseer confirms this exact path as the real source root. |
