...
Generated: 2026-06-30T06:54:33.042Z
Status: `owner_review_packet_guard_failed`

## Summary

- Packet status: owner_review_packet_ready
- Data lane status: kosmodata_lane_sweep_failed
...
- failure: `data_lane_review_only_passed` - Packet must reference a review-only passed data lane.
...
- passed: `source_root_owner_decision_packet_ready` - Source-root owner decision packet must be ready or satisfied.
- passed: `source_root_owner_decision_templates_present` - Source-root owner decision packet must expose decision templates or a satisfied exact root.
...
- passed: `review_order_status:Owner Question Brief` - Owner Question Brief must require an accepted status.
...
- passed: `review_order_status:Question Brief Guard` - Question Brief Guard must require an accepted status.
...
- passed: `review_order_status:Owner Answer Intake` - Owner Answer Intake must require an accepted status.
...
- passed: `review_order_status:Owner Answer Intake Check` - Owner Answer Intake Check must require an accepted status.
...
- passed: `review_order_status:Session Edit Plan` - Session Edit Plan must require an accepted status.
...
- passed: `review_order_status:Source Root Owner Decision Packet` - Source Root Owner Decision Packet must require an accepted status.
