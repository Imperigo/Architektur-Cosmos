...
- passed: `handoff_title:2026-06-13-codex-synergiebericht-114-local-worker-safe-next-tasks.md` - 2026-06-13-codex-synergiebericht-114-local-worker-safe-next-tasks.md must include a title.
- passed: `handoff_mirrored:2026-06-13-codex-synergiebericht-113-owner-review-session-brief-guard.md` - 2026-06-13-codex-synergiebericht-113-owner-review-session-brief-guard.md must be mirrored in both inboxes.
- passed: `handoff_title:2026-06-13-codex-synergiebericht-113-owner-review-session-brief-guard.md` - 2026-06-13-codex-synergiebericht-113-owner-review-session-brief-guard.md must include a title.
- passed: `handoff_mirrored:2026-06-13-codex-synergiebericht-112-owner-review-session-brief.md` - 2026-06-13-codex-synergiebericht-112-owner-review-session-brief.md must be mirrored in both inboxes.
- passed: `handoff_title:2026-06-13-codex-synergiebericht-112-owner-review-session-brief.md` - 2026-06-13-codex-synergiebericht-112-owner-review-session-brief.md must include a title.
- passed: `handoff_mirrored:2026-06-13-codex-synergiebericht-111-owner-review-packet-guard.md` - 2026-06-13-codex-synergiebericht-111-owner-review-packet-guard.md must be mirrored in both inboxes.
- passed: `handoff_title:2026-06-13-codex-synergiebericht-111-owner-review-packet-guard.md` - 2026-06-13-codex-synergiebericht-111-owner-review-packet-guard.md must include a title.
- passed: `handoff_mirrored:2026-06-13-codex-synergiebericht-110-owner-review-packet.md` - 2026-06-13-codex-synergiebericht-110-owner-review-packet.md must be mirrored in both inboxes.
