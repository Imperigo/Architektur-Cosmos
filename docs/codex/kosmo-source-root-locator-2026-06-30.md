...
| `/home/andrin-baumann/.claude/projects/-home-andrin-baumann-ArchitekturKosmos-Codex` | possible_source_root | 42 | 47 | 150 | 0 | `medium_book_count`, `lecture_file_count` |
| `/mnt/archiv/01 ArchitekturKosmos Projekt` | weak_path_signal | 42 | 0 | 280 | 0 | `archive_like`, `lecture_file_count` |
| `/mnt/archiv/01 ArchitekturKosmos Projekt/_overseer-snapshots` | weak_path_signal | 42 | 0 | 748 | 0 | `archive_like`, `lecture_file_count` |
