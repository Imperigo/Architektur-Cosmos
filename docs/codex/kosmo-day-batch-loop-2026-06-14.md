...
Generated: 2026-06-14T14:11:21.189Z
Status: `day_batch_loop_passed_review_only`

## Summary

- Required steps: 39/39
...
| --- | --- | --- |
| `required_steps_passed` | passed | 39/39 |
...
| Bootstrap Data Lane Sweep | passed | no | 21221ms |
| Bootstrap Router | passed | yes | 237ms |
| Core Data Lane Sweep | passed | yes | 17939ms |
...
| Asset Reference Bridge Check | passed | yes | 236ms |
...
| Private Metadata Inventory Fixture Smoke | passed | yes | 315ms |
