...
Generated: 2026-06-15T10:42:39.343Z
...
- Source-root locator probable/candidates: 0/972
...
| --- | --- | ---: | --- |
| KosmoReferences Nightly Gate | passed | 8083ms | `data/kosmoreferences-nightly-gate-2026-06-15.json` |
| KosmoAsset Seed Full Review | passed | 3655ms | `examples/kosmo-assets/kosmoreferences-pilot-seed-library-2026-06-13/review/asset-full-review.generated.json` |
| Human Decision Queue | passed | 245ms | `data/kosmo-human-decision-queue-2026-06-15.json` |
| Owner Decision Batches | passed | 240ms | `data/kosmo-human-decision-owner-batches-2026-06-15.json` |
| Local Worker Output Review | passed | 238ms | `data/kosmo-local-worker-output-review-2026-06-15.json` |
| Pilot Evidence Matrix | passed | 240ms | `data/kosmoreferences-pilot-evidence-matrix-2026-06-15.json` |
| Villa Savoye Provenance Review Brief | passed | 238ms | `data/villa-savoye-provenance-review-brief-2026-06-15.json` |
| Ingenbohl PDF Extraction Brief | passed | 236ms | `data/ingenbohl-pdf-extraction-decision-brief-2026-06-15.json` |
| Sogn Benedetg Source-Root Brief | passed | 236ms | `data/sogn-benedetg-source-root-decision-brief-2026-06-15.json` |
| Source Root Locator | passed | 416ms | `data/kosmo-source-root-locator-2026-06-15.json` |
| Source Root Selection Brief | passed | 237ms | `data/kosmo-source-root-selection-brief-2026-06-15.json` |
| Source Root Decision Session Check | passed | 238ms | `data/kosmo-source-root-decision-session-check-2026-06-15.json` |
| Private Source Inventory Plan | passed | 241ms | `data/kosmo-private-source-inventory-plan-2026-06-15.json` |
| Private Inventory Output Template | passed | 240ms | `examples/kosmo-references/private-inventory/private-inventory-output-template-2026-06-15.json` |
| Private Inventory Output Check | passed | 244ms | `data/kosmo-private-inventory-output-check-2026-06-15.json` |
| Owner Next Review Brief | passed | 244ms | `data/kosmo-owner-next-review-brief-2026-06-15.json` |
| Owner Review Card Set | passed | 237ms | `data/kosmo-owner-review-card-set-2026-06-15.json` |
| Owner Answer Sheet | passed | 239ms | `data/kosmo-owner-answer-sheet-2026-06-15.json` |
| Owner Answer Sheet Check | passed | 239ms | `data/kosmo-owner-answer-sheet-check-2026-06-15.json` |
| Owner Answer Intake Template | passed | 233ms | `examples/kosmo-references/provenance/owner-answer-intake-template-2026-06-15.json` |
| Owner Answer Intake Check | passed | 237ms | `data/kosmo-owner-answer-intake-check-2026-06-15.json` |
| Owner Answer Session Edit Plan | passed | 236ms | `data/kosmo-owner-answer-session-edit-plan-2026-06-15.json` |
| Owner Question Brief | passed | 246ms | `data/kosmo-owner-question-brief-2026-06-15.json` |
| Owner Question Brief Check | passed | 238ms | `data/kosmo-owner-question-brief-check-2026-06-15.json` |
