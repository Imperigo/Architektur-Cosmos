...
Generated: 2026-07-21T15:53:03.798Z
...
- Launch queue idle: yes
- Public-ready after plan: 0

## Items

| Priority | Task | Output | Review | Conversion | Repo now |
| ---: | --- | --- | --- | --- | --- |
| 1 | `kosmo-private-doctrine-summary` | `doctrine-summary.private.md` | present/not_json/0 risk | eligible_for_manual_metadata_review | no |
| 2 | `kosmo-reference-pilot-gap-map` | `reference-pilot-gap-map.private.json` | present/valid/0 risk | eligible_for_manual_metadata_review | no |
