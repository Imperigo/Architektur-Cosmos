...
Generated: 2026-06-30T06:52:11.108Z
Status: `source_root_post_owner_activation_queue_needs_review`
...
- Worker boundary: worker_boundary_pack_guard_failed
- Queue steps: 7
- Executable now: 0
- Blocked now: 7
- Failures: 3
...
| --- | --- | --- | --- | --- |
| `record_owner_decision` | owner | no | `edit examples/kosmo-references/provenance/source-root-decision-session-2026-06-30.json` | human decision required |
...
- Dry run not ready: source_root_decision_dry_run_needs_review
- Private metadata guard not passed: private_metadata_inventory_guard_failed
- Worker boundary guard not passed: worker_boundary_pack_guard_failed
