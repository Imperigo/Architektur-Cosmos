...
Generated: 2026-06-16T12:31:15.805Z
Status: `private_metadata_inventory_guard_passed`

## Summary

- Runner: private_metadata_inventory_ready_private_output_written
- Fixture: private_metadata_inventory_fixture_passed
- Runner files scanned: 5705
...
- passed: `runner_fingerprint_hash:villa-savoye` - runner fingerprint must include path_hash.
- passed: `runner_fingerprint_no_path:villa-savoye` - runner fingerprint must not include raw path.
- passed: `runner_fingerprint_no_content:villa-savoye` - runner fingerprint must not include content.
- passed: `runner_fingerprint_hash:villa-savoye` - runner fingerprint must include path_hash.
- passed: `runner_fingerprint_no_path:villa-savoye` - runner fingerprint must not include raw path.
- passed: `runner_fingerprint_no_content:villa-savoye` - runner fingerprint must not include content.
- passed: `runner_fingerprint_hash:villa-savoye` - runner fingerprint must include path_hash.
...
- passed: `runner_fingerprint_hash:kapelle-sogn-benedetg` - runner fingerprint must include path_hash.
- passed: `runner_fingerprint_no_path:kapelle-sogn-benedetg` - runner fingerprint must not include raw path.
- passed: `runner_fingerprint_no_content:kapelle-sogn-benedetg` - runner fingerprint must not include content.
- passed: `runner_fingerprint_hash:kapelle-sogn-benedetg` - runner fingerprint must include path_hash.
- passed: `runner_fingerprint_no_path:kapelle-sogn-benedetg` - runner fingerprint must not include raw path.
- passed: `runner_fingerprint_no_content:kapelle-sogn-benedetg` - runner fingerprint must not include content.
...
- passed: `runner_fingerprint_hash:alterszentrum-kloster-ingenbohl` - runner fingerprint must include path_hash.
- passed: `runner_fingerprint_no_path:alterszentrum-kloster-ingenbohl` - runner fingerprint must not include raw path.
- passed: `runner_fingerprint_no_content:alterszentrum-kloster-ingenbohl` - runner fingerprint must not include content.
- passed: `runner_fingerprint_hash:alterszentrum-kloster-ingenbohl` - runner fingerprint must include path_hash.
- passed: `runner_fingerprint_no_path:alterszentrum-kloster-ingenbohl` - runner fingerprint must not include raw path.
- passed: `runner_fingerprint_no_content:alterszentrum-kloster-ingenbohl` - runner fingerprint must not include content.
