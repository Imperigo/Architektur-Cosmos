...
32. Generate the owner review packet:

   ```bash
   npm run kosmo:owner-review-packet
   ```

33. Open the generated packet:

   - `docs/codex/kosmo-owner-review-packet-2026-06-13.md`

34. Check the owner review packet:
...
- `overseer_sync_board_guard_passed` means the board is mirrored, decision-free and safe as coordination entry point.
