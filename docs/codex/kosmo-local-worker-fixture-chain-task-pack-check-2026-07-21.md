...
Generated: 2026-07-21T15:53:31.454Z
...
- passed: `task_count_matches_summary` - Task pack must include the summarized legacy and GitHub innovation tasks.
- passed: `three_legacy_tasks` - Task pack must retain the three legacy fixture-chain tasks.
- passed: `github_innovation_tasks_present` - If present, task pack must include at least five source-free GitHub innovation tasks.
- passed: `github_payload_refs_match_tasks` - Task pack must reference two synthetic GitHub fixture payloads per innovation task.
- passed: `training_lanes_present` - GitHub innovation task packs must carry at least three training eval lanes.
- passed: `ontology_entities_present` - GitHub innovation task packs must carry ontology entity bindings.
- passed: `ontology_relations_present` - GitHub innovation task packs must carry ontology relation bindings.
