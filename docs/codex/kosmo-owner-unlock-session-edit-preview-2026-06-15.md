...
Generated: 2026-06-15T15:49:03.857Z
...
- `source-root-session-record-preview` -> `examples/kosmo-references/provenance/source-root-decision-session-2026-06-15.json` (source_root_decision_session_record, writes now: no)
