...
Generated: 2026-06-30T06:52:11.821Z
Status: `source_root_owner_choice_consequence_matrix_needs_review`

## Summary

- Final brief: source_root_owner_final_decision_brief_needs_review
- Dry run: source_root_decision_dry_run_needs_review
- Queue guard: source_root_post_owner_activation_queue_guard_failed
- Choices: 3
- Unlock choices: 1
- Blocked choices: 2
- Failures: 3
...
- Final brief not ready: source_root_owner_final_decision_brief_needs_review
- Decision dry run not ready: source_root_decision_dry_run_needs_review
- Queue guard not passed: source_root_post_owner_activation_queue_guard_failed
