...
Generated: 2026-07-02T06:04:11.350Z
...
- Source-root recommended decision: mount_archive_first_or_confirm_non_archive_root
...
- Source-independent work queue: source_independent_work_queue_needs_review, tasks 9, completed 4, codex executable 3, owner actions 2, failures 5
...
- Prepare source package contract: prepare_phase1_source_package_contract_guard_passed, package kosmo-prepare-phase1-adapter-fixture-2026-07-02, failures 0
...
- Local worker fixture chain task pack: local_worker_fixture_chain_task_pack_missing_refs, tasks 3, executable 0, missing refs 4, check null, failures -
...
| `source-root` Source Root | blocked | yes | blocked: 0 probable libraries, 0 OneDrive markers |
...
| `source-root-owner-action` Source Root Owner Action | blocked | yes | action required: mount_archive_first_or_confirm_non_archive_root |
...
| `source-root-activation` Source Root Activation | blocked | yes | missing, safe commands 0, blocked 0 |
...
| `source-independent-work-queue` Source-Independent Work Queue | needs_review | yes | 9 tasks, completed 4, codex 3, owner 2, failures 5 |
| `private-metadata-inventory` Private Metadata Inventory | needs_review | no | 0 candidates, scanned 0 files |
...
| `prepare-references-asset-fixture-chain` Prepare References Asset Fixture Chain | review_only_ready | no | source package kosmo-prepare-phase1-adapter-fixture-2026-07-02, fixture assets 2, public-ready 0 |
| `fixture-chain-local-worker-task-pack` Fixture Chain Local Worker Task Pack | needs_review | no | 3 tasks, GitHub 0, payloads 0, training 0, executable now 0, missing refs 4 |
...
| `codex-morning-routine-run` Codex Morning Routine Run | needs_review | no | fetch 2/2, behind 0, handoff 353, next source_free_innovation_and_guarding, failures 0 |
...
| `worker-boundary` Worker Boundary | needs_review | no | 0 workers, 0 blocked command classes |
