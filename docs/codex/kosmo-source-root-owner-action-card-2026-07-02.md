...
Generated: 2026-07-02T06:03:41.202Z
...
- Data mount free GiB: unknown
- Archive mount visible: no
- OneDrive marker files: unknown
- Probable large private libraries: unknown
- Workflow mirrors: unknown
...
File: `examples/kosmo-references/provenance/source-root-decision-session-2026-07-02.json`
