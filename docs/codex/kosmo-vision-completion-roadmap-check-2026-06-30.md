...
Generated: 2026-06-30T07:10:02.860Z
...
- passed: `six_phases` - 6
- passed: `owner_unlock_checkpoint_components_ready` - 27/27
- passed: `owner_unlock_checkpoint_guards_ready` - 283/283
- passed: `owner_unlock_handoff_current` - 352
- passed: `source_free_tasks_bounded` - 3
...
- passed: `phase_1_codex_now_mentions_dry_run` - Use checkpoint 27/27 components and 283/283 guards Run npm run kosmo:owner-unlock-answer-dry-run -- --answer "<owner_reply>" before any intake edit Keep source-root private diagnostics blocked until reviewed intake and source-root guards pass
