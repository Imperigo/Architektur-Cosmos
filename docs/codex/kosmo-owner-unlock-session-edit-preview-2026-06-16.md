...
- `source-root-session-record-preview` -> `examples/kosmo-references/provenance/source-root-decision-session-2026-06-16.json` (source_root_decision_session_record, writes now: no)
