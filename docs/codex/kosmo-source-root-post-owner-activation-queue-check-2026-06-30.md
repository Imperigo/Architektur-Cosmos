...
Generated: 2026-06-30T06:52:11.350Z
Status: `source_root_post_owner_activation_queue_guard_failed`

## Summary

- Queue status: source_root_post_owner_activation_queue_needs_review
...
- failure: `queue_ready` - Queue status must be ready.
...
- failure: `queue_internal_failures_zero` - Queue internal failures must be 0.
...
- passed: `record_owner_decision_uses_current_session_date` - Record-owner-decision command must point to source-root-decision-session-2026-06-30.json.
