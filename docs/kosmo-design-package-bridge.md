...
BREP-Referenzen auf, berechnet pro `IFCBUILDINGELEMENTPROXY` eine Bounding Box
...
Der IFC-Geometriepreview fuer das ZG-Testpaket loest 282 von 282 Proxy-Elementen
