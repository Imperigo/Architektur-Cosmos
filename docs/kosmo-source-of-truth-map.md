...
| Kosmo Design / Draw / Viz Proof | `<local_projects>/KosmoDraw` | Blender-Add-on `kosmo_design`, Package Import, Write-back, SVG Draw Export, PNG Viz Preview | Aktive Werkbank, derzeit nicht versioniert. |
...
KosmoDraw
  -> Blender Import / editierbares Modell / Write-back / schnelle Draw+Viz Proofs
KosmoPublish
