...
| `kosmo-zeichner-commands` | Software-Bedienung/Tool-Calling | `sft/kosmo-zeichner-commands/` (P4, Playbook `zod-zu-command-beispielen.md`) | `kosmo-sft/v1` | leer | — | nicht trainiert |
