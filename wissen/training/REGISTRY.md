...
| `kosmo-zeichner-commands` | Software-Bedienung/Tool-Calling | `sft/kosmo-zeichner-commands/` (`commands-v1.jsonl`, P4, Playbook `zod-zu-command-beispielen.md`) | `kosmo-sft/v1` | reproduzierbar | `eval/kosmo-zeichner-commands/` (noch nicht angelegt) | nicht trainiert |
